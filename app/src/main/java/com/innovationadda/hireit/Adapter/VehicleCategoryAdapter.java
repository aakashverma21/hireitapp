...
//        }
        ...
        if (url.equalsIgnoreCase("sedan")){
            urlchange=R.drawable.sedan1;
        }else if (url.equalsIgnoreCase("hatchback")){
            urlchange=R.drawable.hatchback;
        }else if (url.equalsIgnoreCase("muv")){
            urlchange=R.drawable.muv;
        }else if (url.equalsIgnoreCase("suv")){
            urlchange=R.drawable.suv;
        }

//        Log.d("MainActivity",url);

        Picasso.get().load(urlchange).into(vehicleCategoryHolder.categoryImage);
    }
