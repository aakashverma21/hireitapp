...
//                        );
                        myDb.insertData(String.valueOf(id),
                                firstName,
                                middleName, lastName,email,driverLicense,expiry,dateOfBirth,phoneNumber,street,city,postalCode,password,confirm_password);

                        Toast.makeText(RegistrationActivity.this, "Your are Successfully Registered with Hire-It", Toast.LENGTH_LONG).show();
